...
class TestRoute:
    ...
    def test_route(self):
        res = self.py_osrm.Route(two_test_coordinates)
    ...
    def test_route_mld(self):
        ...
        res = py_osrm.Route([(13.43864,52.51993),(13.415852,52.513191)])
        assert(res["waypoints"])
        assert(res["routes"])
        assert(res["routes"][0]["geometry"])
    ...
    def test_route_alternatives(self):
        ...
        # Use RouteParameters for advanced options
        route_params = osrm.RouteParameters()
        route_params.coordinates = two_test_coordinates
    ...
    def test_route_geometrycompression(self):
        ...
        assert(isinstance(res["routes"][0]["geometry"]["coordinates"], list))
    ...
    def test_route_speedannotations(self):
        ...
        simplified_res = self.py_osrm.Route(
            coordinates = two_test_coordinates,
            continue_straight = False,
            overview = "simplified",
            geometries = "polyline",
